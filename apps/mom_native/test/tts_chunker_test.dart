...
void main() {
  ...
  test('later chunks stay bounded and prefer sentence or clause boundaries', () {
  ...
  test('very long unpunctuated speech is still bounded without dropping text', () {
  ...
  test('voice service never synthesizes more than two chunks ahead', () async {
