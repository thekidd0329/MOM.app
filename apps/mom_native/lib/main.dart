    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          SwitchListTile(
            title: const Text('Anonymous learning contributions'),
            subtitle: const Text(
              'Share locally de-identified user text with MOM’s research '
              'service. Raw conversations stay on this device.',
            ),
